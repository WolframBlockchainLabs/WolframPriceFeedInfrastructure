export default [
    {
        ...
        before: async ({ factory }) => {
            const { exchangeName, symbol, newOrderBook } =
        ...
        test: async ({ t, coreAPI, exchangeName, symbol, newOrderBook }) => {
            const res = await coreAPI.get(
                `/exchanges/${exchangeName}/markets/${symbol}/orderBooks`,
            );
    ...
    },
    {
        ...
        test: async ({ t, coreAPI, symbol }) => {
            const res = await coreAPI.get(
                `/exchanges/test/markets/${symbol}/orderBooks`,
            );
    ...
    },
    {
        ...
        test: async ({ t, coreAPI, exchangeName }) => {
            const res = await coreAPI.get(
                `/exchanges/${exchangeName}/markets/test/orderBooks`,
            );
    ...
    },
    {
        ...
        test: async ({ t, coreAPI, exchangeName, symbol }) => {
            const res = await coreAPI.get(
                `/exchanges/${exchangeName}/markets/${symbol}/orderBooks?rangeDateStart=2023-06-05%2001:38:37&rangeDateEnd=qq`,
            );
    ...
    },
    {
        ...
        test: async ({ t, coreAPI, exchangeName, symbol }) => {
            const res = await coreAPI.get(
                `/exchanges/${exchangeName}/markets/${symbol}/orderBooks?rangeDateStart=2023-06-05%2001:38:37&rangeDateEnd=2023-06-04%2001:38:37`,
            );
