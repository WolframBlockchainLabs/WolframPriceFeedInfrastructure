export default [
    ...
    },
    {
        ...
        test: async ({ t, coreAPI }) => {
            const res = await coreAPI.get(
                '/exchanges/Binance,Kraken/markets/BTC_USDT/orderBooks?rangeDateStart=2023-06-05%2001:38:37&rangeDateEnd=qq',
            );
    ...
    },
    {
        ...
        test: async ({ t, coreAPI }) => {
            const res = await coreAPI.get(
                '/exchanges/Binance,Kraken/markets/BTC_USDT/orderBooks?rangeDateStart=2023-06-05%2001:38:37&?rangeDateStart=2023-06-05%2001:38:37&rangeDateEnd=2023-06-04%2001:38:37',
            );
