...
const fetchOHLCVStubResult = [ [ faker.number.float(), faker.number.float(), faker.number.float() ] ];
...
test.beforeEach(t => {
    ...
    t.context.candleStickCollector = new CandleStickCollector({ exchange, symbol }, sequelize, marketId);
});
