...
module.exports = {
    up : async (queryInterface, Sequelize) => {
        await queryInterface.createTable('Exchanges', {
            ...
            externalExchangeId : { type: Sequelize.STRING, allowNull: false, unique: true },
        ...
        await queryInterface.createTable('Markets', {
            ...
            exchangeId       : { type: Sequelize.INTEGER, allowNull: false, references: { model: 'Exchanges', key: 'id' } }
        });
