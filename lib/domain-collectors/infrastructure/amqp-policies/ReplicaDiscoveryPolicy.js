...
class ReplicaDiscoveryPolicy extends BaseAMQPPolicy {
    ...
    constructor({ rabbitGroupName, replicaDiscovery, ...options }) {
        ...
        this.validateReplicaDiscoveryConfig(replicaDiscovery);
    }
    ...
    async statusConsumer(data) {
        ...
        this.debounceTimeout = setTimeout(async () => {
            ...
            this.messageBuffer = [];
            this.setProtocolStatus(
                ReplicaDiscoveryPolicy.PROTOCOL_STATUSES.RUNNING,
            );
    ...
    validateReplicaDiscoveryConfig({ initializationDelay, debounceDelay }) {
        if (initializationDelay < debounceDelay) {
            throw new Error(
                "ReplicaDiscoveryPolicy's initializationDelay can't be lower than debounceDelay",
            );
        }
    }
