...
class CollectorsManager {
    constructor({
        ...
        console.log({
            ...
            symbol,
            pair,
            exchangeAPI: exchangeAPI.constructor.name,
            amqpClient: amqpClient.constructor.name,
            logger: logger.constructor.name,
            collectorsScheduler,
            marketsManager: marketsManager.constructor.name,
        });
    ...
    async updateRateLimit({ newRateLimitMultiplier, shouldSleep }) {
