...
class GapChecker extends BaseUseCase {
    ...
    async execute(config) {
        this.logger.info(
            `Starting GapChecker for ${config.datatype} in [${config.rangeDateStart}, ${config.rangeDateEnd}]`,
        );
        ...
        this.logger.info({
            message: `GapChecker results for ${config.datatype} in [${config.rangeDateStart}, ${config.rangeDateEnd}]`,
            results,
        });
