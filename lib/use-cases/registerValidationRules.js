...
const defaultRules = {
    ...
    'date_compare'() {
        return (value, params) => {
            ...
            if (rangeDateStart > rangeDateEnd) return 'DATE START CANNOT BE LATE THAN DATA END';
        };
    },
    'iso_timestamp'() {
        return (value) => {
            ...
            if (!isoDateRegex.test(value) && !isoTimestampRegex.test(value)) return 'INVALID_ISO_DATE_OR_TIMESTAMP';
