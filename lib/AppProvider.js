...
import getIp from './infrastructure/ip.js';
import { initLogger } from './infrastructure/logger/logger.js';
import WinstonMail from './infrastructure/logger/WinstonMail.js';
    ...
    async initLogger() {
        ...
        WinstonMail.setSender(async (info) => {
            ...
            if (notificationEmail) {
                await this.notificator.notify('EMERGENCY', notificationEmail, {
                    details,
                    ip,
                });
            }
