...
export default class Market extends Base {
    ...
    static initRelations() {
        ...
        this.hasMany(CandleStick, { foreignKey: 'marketId', sourceKey: 'id', as: 'candleStick' });
        this.hasMany(Ticker, { foreignKey: 'marketId', sourceKey: 'id', as: 'Ticker' });
        this.hasMany(Trade, { foreignKey: 'marketId', sourceKey: 'id', as: 'trade' });
    }
}
